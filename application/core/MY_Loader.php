...
class MY_Loader extends CI_Loader {
	...
	private $_css = array();
	private $_inline_styling = array("infile"=>"", "stripped"=>"", "unstripped"=>"");
	...
	function start_inline_styling(){
		ob_start();
	}

	function end_inline_styling($strip_tags=true, $append_to_file=true){
		$source = ob_get_clean();
		 ...
		 if($append_to_file){
		 	...
		 	$this->_inline_styling['infile'] .= $source;

		 }else{

		 	if($strip_tags){
		 		$this->_inline_styling['stripped'] .= $source;
		 	}else{
		 		$this->_inline_styling['unstripped'] .= $source;
		 	}
		 }
	}
	...
	function get_inline_styling(){
		return $this->_inline_styling;
	}
